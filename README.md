...
NQA Auditor Webapp Community is an independent reference architecture and experimental platform for exploring web-first digital auditing. It is intended for developers, auditors, certification professionals, consultants, researchers, trainers, and contributors who want a practical domain model for structured conformity-assessment workflows.
...
NQA Auditor Webapp Community is developed as an open community initiative to explore better digital tools for professional auditing, conformity assessment and AI-assisted audit workflows.
...
<p align="center">
  <img src="assets/donate-qr.png"
       alt="Support NQA Auditor Webapp Community"
       width="280">
</p>
...
NQA Auditor Webapp Community is an independent project developed by NQA Viet Nam.
